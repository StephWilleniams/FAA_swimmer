...
void partpair_tester_IVP(int ns, double x[][4]){
...
void no_OL_IVP(int ns, double xs[][4], int np, double xp[][2], double xL, double xR, double yB, double yT, double rS, double rP, mt19937& gen){
    int check;
    double l;
